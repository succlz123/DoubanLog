...
public class ApiUrlHelper {
    ...
    public static final String USER_INFO = "https://api.douban.com/v2/user/~me";//api获取用户信息
    public static final String BASE = "https://api.douban.com";//api入口
...
//    public static final String USER_BOOK_REVIEWS = "https://frodo.douban.com/api/v2/book/:id/reviews?udid=&apikey=&channel=WanDouJia_Parter&count=";//获取图书评论
    ...
    public static final String USER_SET_ANNOTATIONS = "https://api.douban.com/v2/book/:id/annotations";//给某本图书写笔记
    public static final String USER_SETREVIEWS = "https://api.douban.com/v2/book/reviews?book";
